...
const Kids: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-br from-yellow-50 via-orange-50 to-pink-50 py-20">
      ...
      <div className="container mx-auto px-6 py-16">
        {products.length === 0 ? (
          <div className="text-center py-20">
            ...
            <p className="text-lg text-gray-600">Check back soon for amazing kids' clothing!</p>
          </div>
        ) : (
          <>
